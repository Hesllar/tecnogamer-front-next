  ...
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-700 mt-2 dark:text-gray-200">
          Página no encontrada
        </p>
        <p className="text-lg md:text-xl lg:text-2xl text-gray-600 my-12 dark:text-gray-300">
          Lo sentimos, no se pudo encontrar la página que estás buscando.
        </p>
        <Link
          href={"/"}
          className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded transition duration-500"
          title="Return Home"
        >
          <svg
